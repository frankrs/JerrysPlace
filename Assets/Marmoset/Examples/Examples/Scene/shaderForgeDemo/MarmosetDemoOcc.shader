...
/*SF_DATA;ver:0.34;sub:START;pass:START;ps:flbk:,lico:1,lgpr:1,nrmq:1,limd:1,uamb:False,mssp:False,lmpd:True,lprd:False,enco:False,frtr:True,vitr:True,dbil:False,rmgx:True,rpth:0,hqsc:True,hqlp:False,blpr:0,bsrc:0,bdst:1,culm:2,dpts:2,wrdp:True,ufog:True,aust:True,igpj:False,qofs:0,qpre:1,rntp:1,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,ofsf:0,ofsu:0,f2p0:False;n:type:ShaderForge.SFN_Final,id:1,x:31995,y:32539|diff-35-OUT,spec-23-OUT,gloss-56-OUT,normal-72-RGB,amdfl-3-RGB,amspl-4-RGB;n:type:ShaderForge.SFN_Color,id:2,x:33341,y:32082,ptlb:Diffuse Color,ptin:_DiffuseColor,glob:False,c1:0.5,c2:0.5,c3:0.5,c4:1;n:type:ShaderForge.SFN_SkyshopDiff,id:3,x:32319,y:32743,dfrot:True,dfblend:True,dflmocc:True;n:type:ShaderForge.SFN_SkyshopSpec,id:4,x:32319,y:32918,sprot:True,spblend:True,splmocc:True|GLOSS-56-OUT;n:type:ShaderForge.SFN_Color,id:21,x:33340,y:32781,ptlb:Specular Color,ptin:_SpecularColor,glob:False,c1:1,c2:1,c3:1,c4:1;n:type:ShaderForge.SFN_Fresnel,id:22,x:33120,y:32410;n:type:ShaderForge.SFN_Multiply,id:23,x:32567,y:32578|A-29-OUT,B-44-OUT;n:type:ShaderForge.SFN_Multiply,id:24,x:32919,y:32410|A-22-OUT,B-22-OUT,C-22-OUT;n:type:ShaderForge.SFN_Lerp,id:29,x:32567,y:32410|A-30-OUT,B-32-OUT,T-31-OUT;n:type:ShaderForge.SFN_Vector1,id:30,x:32752,y:32343,v1:1;n:type:ShaderForge.SFN_Slider,id:31,x:33183,y:32339,ptlb:Fresnel Falloff,ptin:_FresnelFalloff,min:0,cur:0,max:1;n:type:ShaderForge.SFN_RemapRange,id:32,x:32752,y:32410,frmn:0,frmx:1,tomn:0.05,tomx:1|IN-24-OUT;n:type:ShaderForge.SFN_Tex2d,id:33,x:33341,y:31900,ptlb:MainTex,ptin:_MainTex,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Multiply,id:35,x:33121,y:31900|A-33-RGB,B-2-RGB;n:type:ShaderForge.SFN_Tex2d,id:42,x:33340,y:32597,ptlb:SpecTex,ptin:_SpecTex,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Multiply,id:44,x:33116,y:32597|A-78-OUT,B-42-RGB,C-21-RGB;n:type:ShaderForge.SFN_Multiply,id:56,x:33116,y:32743|A-42-A,B-21-A,C-95-OUT;n:type:ShaderForge.SFN_Tex2d,id:72,x:33340,y:33116,ptlb:BumpMap,ptin:_BumpMap,ntxv:3,isnm:True;n:type:ShaderForge.SFN_ValueProperty,id:78,x:33340,y:32526,ptlb:Specular Intensity,ptin:_SpecularIntensity,glob:False,v1:1;n:type:ShaderForge.SFN_Slider,id:95,x:33340,y:32955,ptlb:Specular Sharpness,ptin:_SpecularSharpness,min:0,cur:1,max:1;proporder:2-21-78-95-31-33-42-72;pass:END;sub:END;*/
...
/////// Normals:
                ...
                float3 normalLocal = UnpackNormal(tex2D(_BumpMap,TRANSFORM_TEX(node_117.rg, _BumpMap))).rgb;
...
/////// Diffuse:
                ...
                #endif
///////// Gloss:
                float4 node_42 = tex2D(_SpecTex,TRANSFORM_TEX(node_117.rg, _SpecTex));
...
////// Specular:
                ...
                float3 specularAmb = (lightmap*marmoMipSpecular(viewReflectDirection, i.posWorld.rgb, node_56)).rgb * specularColor;
                ...
                diffuseLight += (lightmap*marmoDiffuse(normalDirection)).rgb; // Diffuse Ambient Light
                finalColor += diffuseLight * (tex2D(_MainTex,TRANSFORM_TEX(node_117.rg, _MainTex)).rgb*_DiffuseColor.rgb);
                finalColor += specular;
/// Final Color:
...
/////// Normals:
                ...
                float3 normalLocal = UnpackNormal(tex2D(_BumpMap,TRANSFORM_TEX(node_118.rg, _BumpMap))).rgb;
                float3 normalDirection =  normalize(mul( normalLocal, tangentTransform )); // Perturbed normals
...
/////// Diffuse:
                ...
                float3 diffuse = max( 0.0, NdotL) * attenColor;
///////// Gloss:
                float4 node_42 = tex2D(_SpecTex,TRANSFORM_TEX(node_118.rg, _SpecTex));
                float node_56 = (node_42.a*_SpecularColor.a*_SpecularSharpness);
                float gloss = node_56;
                float specPow = exp2( gloss * 10.0+1.0);
////// Specular:
                ...
                float3 finalColor = 0;
                float3 diffuseLight = diffuse;
                finalColor += diffuseLight * (tex2D(_MainTex,TRANSFORM_TEX(node_118.rg, _MainTex)).rgb*_DiffuseColor.rgb);
                finalColor += specular;
/// Final Color:
